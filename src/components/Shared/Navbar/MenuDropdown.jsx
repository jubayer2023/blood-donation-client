...
const MenuDropdown = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* dropdown box */}
      <div
        className={`absolute rounded-md transition transform  ease-in-out  -z-10 shadow-inner shadow-slate-600 w-[40vw] md:w-[20vw] lg:w-[10vw] bg-neutral-100  overflow-hidden right-0 top-[58px]  text-sm ${
          isOpen
